...
class Snake():
	...
	def appendToSnake(self, x, y):
	    ...
	    if event.direction == "down" and self.direction != self.UP:
	    	self.direction = self.DOWN

	    elif event.direction == "up" and self.direction != self.DOWN:
		self.direction = self.UP

	    elif event.direction == "right" and self.direction != self.LEFT:
		self.direction = self.RIGHT

	    elif event.direction == "left" and self.direction != self.RIGHT:
